...
| | |
|:---|:---|
| 🔢 **Totaal unieke IPs** | **163,937** |
| 📦 **Chunk bestanden** | 8 bestanden (max 35,000 per bestand) |
| 🔄 **Laatste update** | 2026-04-21 02:57:52 UTC |
...
📂 Repository
├── 📄 README.md
├── 📄 SV-SIEM-All-ThreatIPs-IPv4.txt          ← Volledige lijst (163,937 IPs)
└── 📂 Fortigate/
...
<sub>🤖 Automatisch gegenereerd door **SV-SIEM** op 2026-04-21 02:57:52 UTC</sub>
